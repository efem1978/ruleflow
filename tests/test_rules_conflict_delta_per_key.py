...
def test_per_key_conflict_delta(tmp_path: Path) -> None:
    ...
    m1 = tmp_path / 'm1.md'; m1.write_text('- 覆盖率 90%', encoding='utf-8')
    m2 = tmp_path / 'm2.md'; m2.write_text('- 覆盖率 94%', encoding='utf-8')
    c1 = tmp_path / 'c1.md'; c1.write_text('- 核心 95%', encoding='utf-8')
    c2 = tmp_path / 'c2.md'; c2.write_text('- 核心 98%', encoding='utf-8')
