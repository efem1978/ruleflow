...
- Unify VS Code coverage gate to 98% across docs/CI
...
- CI health check doc now aligned with README on 98% VS Code threshold
...
Quality Gates
- Python: 665 passed; weak=[]; core ≥98%, others ≥95%; -W error; no skip/xfail
- VS Code: CI gate at 98% (fake backend); near/worst exported to artifact `vscode-near`
